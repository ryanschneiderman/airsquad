...
class MembersController < ApplicationController
	def player_profile
		...
		@advanced_stats = SeasonAdvancedStat.joins(:stat_list).select("stat_lists.stat as stat, stat_lists.display_priority as display_priority, season_advanced_stats.*").where("stat_lists.rankable" => true, "stat_lists.team_stat" => false, "season_advanced_stats.member_id" => member_id).sort_by{|e| e.display_priority}
