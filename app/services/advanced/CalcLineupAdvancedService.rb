...
class Advanced::CalcLineupAdvancedStatsService

	def initialize(params)
		@lineup_id = params[:lineup_id]
		@team_id = params[:team_id]

		@field_goals = LineupStat.where(lineup_id: @lineup_id, is_opponent: false, stat_list_id: 1)
		@field_goal_misses = LineupStat.where(lineup_id: @lineup_id, is_opponent: false, stat_list_id: 2)
		@field_goal_att = @field_goals + @field_goal_misses

		@free_throw_makes = LineupStat.where(lineup_id: @lineup_id, is_opponent: false, stat_list_id: 13)
		@free_throw_misses = LineupStat.where(lineup_id: @lineup_id, is_opponent: false, stat_list_id: 14)
		@free_throw_attempts = @free_throw_makes + @free_throw_misses

		@turnovers = LineupStat.where(lineup_id: @lineup_id, is_opponent: false, stat_list_id: 7)
		@off_reb = LineupStat.where(lineup_id: @lineup_id, is_opponent: false, stat_list_id: 4)
		@def_reb = LineupStat.where(lineup_id: @lineup_id, is_opponent: false, stat_list_id: 5)
		@points = LineupStat.where(lineup_id: @lineup_id, is_opponent: false, stat_list_id: 15)
		@three_point_fg = LineupStat.where(lineup_id: @lineup_id, is_opponent: false, stat_list_id: 11)
		@assists = LineupStat.where(lineup_id: @lineup_id, is_opponent: false, stat_list_id: 3)


		@opp_field_goal_makes = LineupStat.where(lineup_id: @lineup_id, is_opponent: true, stat_list_id: 1)
		@opp_field_goal_misses = LineupStat.where(lineup_id: @lineup_id, is_opponent: true, stat_list_id: 2)
		@opp_field_goal_att = @opp_field_goal_makes + @opp_field_goal_misses

		@opp_free_throw_makes = LineupStat.where(lineup_id: @lineup_id, is_opponent: true, stat_list_id: 13)
		@opp_free_throw_misses = LineupStat.where(lineup_id: @lineup_id, is_opponent: true, stat_list_id: 14)
		@opp_free_throw_att = @opp_free_throw_makes + @opp_free_throw_misses

		@opp_turnovers = LineupStat.where(lineup_id: @lineup_id, is_opponent: true, stat_list_id: 7)
		@opp_off_reb = LineupStat.where(lineup_id: @lineup_id, is_opponent: true, stat_list_id: 4)
		@opp_def_reb = LineupStat.where(lineup_id: @lineup_id, is_opponent: true, stat_list_id: 5)
		@opp_points = LineupStat.where(lineup_id: @lineup_id, is_opponent: true, stat_list_id: 15)
