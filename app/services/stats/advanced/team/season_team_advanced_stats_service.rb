...
class Stats::Advanced::Team::SeasonTeamAdvancedStatsService
	...
	def initialize(params)
		...
		@team_three_point_makes = TeamSeasonStat.where(team_id: @team_id, stat_list_id: 11, is_opponent: false, season_id: @season_id).take.value
		@team_three_point_misses = TeamSeasonStat.where(team_id: @team_id, stat_list_id: 12, is_opponent: false, season_id: @season_id).take.value
		@opp_three_point_makes = TeamSeasonStat.where(team_id: @team_id, stat_list_id: 11, is_opponent: true, season_id: @season_id).take.value
		

    	@team_minutes = TeamSeasonStat.where(team_id: @team_id, stat_list_id: 16, is_opponent: false, season_id: @season_id).take.value
